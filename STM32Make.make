...
Drivers/Peripheral/Src/ADS131E08.c \
...
GCC_PATH="D:/888_Workspace/999_Tools/gcc-arm-none-eabi-10-2020-q4-major/bin
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/888_WORKSPACE/999_TOOLS/OPENOCD-20210519-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/888_WORKSPACE/999_TOOLS/OPENOCD-20210519-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f7x mass_erase 0; exit"
